...
const Service = () => {
  return (
    <div className="bg-[#EAF3F6] py-3 md:py-10">
      <div className="box flex flex-col md:flex-row justify-center my-8 mx-auto md:w-[70%] ">
        ...
        <div className="details md:w-[65%] p-5 text-[#333333] md:mx-5">
          ...
          <div
            style={{ fontSize: "50px" }}
            className="text-[#05A0E2] md:text-7xl my-8"
          >
            <svg id="Layer_1" x="0px" y="0px" width="60" viewBox="0 0 30 30">
              <path
                fill="currentColor"
          ...
          <h2
            style={{ fonFamily: "Montserrat, Sans-serif", fontWeight: "800" }}
            className="uppercase text-3xl  text-[#333333] font-bold mx-auto"
          >
            <b>Air Conditioning Repair Service</b>
          </h2>
          <p
      ...
      <div className="box flex flex-col md:flex-row justify-center md:mt-20 mx-auto  md:w-[70%] ">
        <div className="details md:w-[65%] p-5 text-[#333333] md:mx-8">
          ...
          <h2
            ...
            className="uppercase text-3xl  text-[#333333] font-bold mx-auto"
          >
            <b> Why Air Con Company For AC Repair</b>
          </h2>
          <p
